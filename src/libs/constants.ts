const BUTTON_NODES_COUNT = process.env.VITE_BUTTON_NODES_COUNT;
...
const CHECKBOX_NODES_COUNT = process.env.VITE_CHECKBOX_NODES_COUNT;
...
const TEXT_INPUT_NODES_COUNT = process.env.VITE_TEXT_INPUT_NODES_COUNT;
...
const TEXTAREA_NODES_COUNT = process.env.VITE_TEXT_AREA_NODES_COUNT;
...
const SWITCH_NODES_COUNT = process.env.VITE_SWITCH_NODES_COUNT;
...
const LABEL_NODES_COUNT = process.env.VITE_LABEL_NODES_COUNT;
...
const TEXT_NODES_COUNT = process.env.VITE_TEXT_NODES_COUNT;
...
const NUMBER_INPUT_NODES_COUNT = process.env.VITE_NUMBER_INPUT_NODES_COUNT;
...
const RADIO_GROUP_NODES_COUNT = process.env.VITE_RADIO_GROUP_NODES_COUNT;
...
const LINK_NODES_COUNT = process.env.VITE_LINK_NODES_COUNT;
...
const AVATAR_NODES_COUNT = process.env.VITE_AVATAR_NODES_COUNT;
